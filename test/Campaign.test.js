...
beforeEach(async () => {
  ...
  [campaignAddess] = await factory.methods.getDeployedCampaigns().call();
...
describe('Campaigns', () => {
  ...
  it('allows a manager to make a payment request', async () => {
    await campaign.methods.createRequest("Buy prototypes", '100', accounts[1])
      .send({
        from: accounts[0],
        gas: '1000000'
    });
    ...
    assert.equal('Buy prototypes', request.description);
  });
